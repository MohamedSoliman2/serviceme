            ...
            <div class="nav-notification__details">
                <p style="max-width: 200px; text-wrap:wrap;">
                    <a href="#" class="subject stretched-link text-truncate"
                        style="max-width: 180px; "id="hrefedg"></a>
                ...
                <div class="dropdown-custom">
                    ...
                    <div class="dropdown-wrapper">
                        <h2 class="dropdown-wrapper__title">Notifications <span
                                class="badge-circle badge-warning ms-1"></span></h2>
                        <ul id="listnotify">
                            ...
                            <li class="nav-notification__single nav-notification__single--unread d-flex flex-wrap">
                                ...
                                <div class="nav-notification__details">
                                    <p style="max-width: 200px; text-wrap:wrap;">
                                        ...
                                        <a style="white-space: wrap;" href=""
                                            class="subject stretched-link text-truncate" style="max-width: 180px; "></a>
