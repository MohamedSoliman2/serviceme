...
#totakeclone{
    ...
    <div class="navbar-left">
        <div class="logo-area">
                ...
                @php 
            $x='login';
            if(Auth::user()->type=="system_admin" || Auth::user()->type=="admin_assistant"){
                $x='dashboard.demo_four';
            }elseif(Auth::user()->type=="parent"){
            $x='dashboard.demo_two';
            }elseif(Auth::user()->type=="school_admin" || Auth::user()->type=="school_assistant"){
                $x='dashboard.demo_one';
            }
            @endphp
            
            <a class="navbar-brand" href="{{ route($x,app()->getLocale()) }}">
