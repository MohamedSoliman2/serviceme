<div class="sidebar__menu-group">
    <ul class="sidebar_nav">
        ...
        <li>
            <a href="{{ route('admin.blog.index') }}" class="i">
        ...
        <li class="has-child">
            ...
            <ul>
                ...
                <li><a href="{{ route('admin.footer', ['type' => 'blog']) }}" class="i">فوتر صفحه المقالات</a>
                </li>
        ...
        <li class="has-child">
            ...
            <ul>
                ...
                <li> <a href="{{ route('admin.footer', ['type' => 'about']) }}" class="i">فوتر صفحه عنا</a>
                </li>
                <li><a href="{{ route('end.admin.footer') }}" class="i"> مربعات ال فوتر</a></li>
            </ul>
        </li>
        <li class="has-child">
            ...
            <ul>
                ...
                <li><a href="{{ route('admin.footer', ['type' => 'term']) }}" class="i">فوتر صفحه الشروط
                        والاحكام</a></li>
                <li><a href="{{ route('end.admin.footer') }}" class="i"> مربعات ال فوتر</a></li>
            </ul>
        </li>
        ...
        <li class="has-child">
            ...
            <ul>
                <li><a href="{{ route('admin.locationheader.index') }}" class="active">التحكم في صفحه
                        العناوين</a></li>
                <li><a href="{{ route('admin.testmonial.index') }}" class="i">اراء العملاء</a></li>
                <li><a href="{{ route('admin.location.description.index') }}" class="i">صفحه العناوين
                        التفاصيل</a></li>
                <li><a href="{{ route('faqs.index') }}" class="i">الاسئله الشائعه</a></li>
                <li><a href="{{ route('admin.footer', ['type' => 'location']) }}" class="i">فوتر صفحه
                        الموقع</a></li>
                <li><a href="{{ route('end.admin.footer') }}" class="i"> مربعات ال فوتر</a></li>
            </ul>
        </li>
