@section('title', isset($terms) ? 'تعديل الشروط والأحكام' : 'اضافه شروط وأحكام')
@section('description', isset($terms) ? 'تعديل الشروط والأحكام' : 'اضافه شروط وأحكام')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex align-items-center user-member__title mb-30 mt-30">
                    <h4 class="text-capitalize">{{ isset($terms) ? 'تعديل الشروط والأحكام' : 'اضافه شروط وأحكام' }}</h4>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card-body mt-2">
                <form action="{{ isset($terms) ? route('terms.update', $terms->id) : route('terms.store') }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group mt-2">
                                ...
                                <textarea class="form-control mt-2" name="description" style="height: 375px;padding:20px;" id="editor">{{ isset($terms) ? $terms->description : old('description') }}</textarea>
                            </div>
