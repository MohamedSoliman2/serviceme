        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex align-items-center user-member__title mb-30 mt-30">
                    <h4 class="text-capitalize">تعديل الجائزه</h4>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-sm-5 col-10">
                    <div class="mt-40 mb-50"> -->
                        ...
                        <form action="{{ route('admin.awards.update',$awards->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="account-profile d-flex align-items-center mb-4 " style="margin-left: 50px; justify-content:center;">
                                <div class="ap-img pro_img_wrapper">
                                    ...
                                    <label for="profile-picture">
                                        <img src="{{url('/').'/../storage/app/public/'.$awards->image}}" alt="user" class="profile-picture-preview ap-img__main rounded-circle wh-120 bg-lighter d-flex">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text"  class="form-control mt-2"
                                        name="title" value="{{ $awards->title }}" id="name" placeholder="الاسم">
                                    @if ($errors->has('name'))
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <textarea class="form-control mt-2" name="description" style="height: 175px;padding:20px;"
                                        id="description" >{{ $awards->description }}</textarea>
                                </div>
