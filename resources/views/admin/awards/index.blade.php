                                        ...
                                        @else
                                            @foreach ($awards as $award)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="userDatatable-content">
                                                 <img src="{{url('/').'/../storage/app/public/'.$award->image}}" alt="##" width="50" height="50" style="border-radius: 50%;">          
                                                        </div>
                                                    </td>
                                ...
                                <li class="dm-pagination__item">
                                    <div class="paging-option">
                                        <select name="page-number" class="page-selection" onchange="updatePagination( event )">
                                            <option value="20" {{ 20 == $awards->perPage() ? 'selected' : '' }}>20/page</option>
                                            <option value="40" {{ 40 == $awards->perPage() ? 'selected' : '' }}>40/page</option>
                                            <option value="60" {{ 60 == $awards->perPage() ? 'selected' : '' }}>60/page</option>
                                        </select>
