        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex align-items-center user-member__title mb-30 mt-30">
                    <h4 class="text-capitalize">تعديل الفوتر</h4>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-sm-5 col-10">
                    <div class="mt-40 mb-50"> -->
                        ...
                        <form action="{{ route('admin.footer.update',['type' => $type]) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="account-profile d-flex align-items-center mb-4 " style="margin-left: 50px; justify-content:center;">
                                ...
                                <div class="account-profile__title">
                                    <h6 class="fs-15 ms-20 fw-500 text-capitalize">صوره الفوتر</h6>
                                </div>
                                @error('photo')
                                    {{$message}}
                                @enderror
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <label for="name" >اسم الفوتر<span
                                            class="text-danger">*</span></label>
                                    <input type="text"  class="form-control mt-2"
                                        name="title" value="{{ $footer->header }}" id="name" placeholder="الاسم">
                                    @if ($errors->has('name'))
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <textarea class="form-control mt-2" name="description" style="height: 175px;padding:20px;"
                                        id="description" >{{ $footer->description }}</textarea>
                                </div>
