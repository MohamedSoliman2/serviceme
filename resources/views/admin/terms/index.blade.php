                    ...
                    <div class="breadcrumb-main add-contact justify-content-sm-between ">
                        <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                            <div class="d-flex align-items-center add-contact__title justify-content-center me-sm-25">
                                <h4 class="text-capitalize fw-500 breadcrumb-title">صفحه الشروط والاحكام</h4>
                                <span class="sub-title ms-sm-25 ps-sm-25"></span>
                            </div>
                            @if (count($term)==0)
                            <div class="action-btn mt-sm-0 mt-15">
                                <a href="{{ route('terms.create') }}" class="btn px-20 btn-primary ">
                                    <i class="las la-plus fs-16"></i>اضافه صفحه الشروط
                                </a>
                                ...
                                <table class="table mb-0 table-borderless">
                                    <thead>
                                        <tr class="userDatatable-header">  
                                            ...
                                            <th>
                                                <span class="userDatatable-title"> الشروط</span>
                                            </th>
                                    ...
                                    <tbody>
                                        @if (count($term) == 0)
                                            <tr>
                                                <td colspan="7">
                                                    <p class="text-center">{{trans('قم باضافه صفحه الشروط')}}</p>
                                                </td>
                                            </tr>
                                        @else
                                            @foreach ($term as $one)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
                                                            ...
                                                            <li>
                                                                <a href="{{ route('terms.edit', $one->id) }}"
                                                                    class="edit">
                                                                ...
                                                                <form style="display:none;" id="delete-{{ $one->id }}"
                                                                    action="{{ route('terms.delete',$one->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('post')
                                                                </form>
