        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex align-items-center user-member__title mb-30 mt-30">
                    <h4 class="text-capitalize">اضافه مقاله</h4>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text"  class="form-control mt-2"
                                        name="title" value="{{ old('title') }}" id="title" placeholder="الاسم">
                                    @if ($errors->has('title'))
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <textarea class="form-control mt-2" name="description" style="height: 375px;padding:20px;"
