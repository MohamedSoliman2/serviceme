...
@section('description', 'تعديل منشور')
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex align-items-center user-member__title mb-30 mt-30">
                    <h4 class="text-capitalize">تعديل منشور</h4>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            ...
            <div class="card-body mt-2">
                <form action="{{ route('admin.location.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row flex flex-column justify-content-center">
                        <div class="col-sm-6">
                            <div class="form-group mt-2">
                                ...
                                <input type="text" class="form-control mt-2" name="title" value="{{ $post->title }}"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mt-2">
                                ...
                                <textarea class="form-control mt-2" name="description" style="height: 375px;padding:20px;" id="editor">{{ $post->description }}</textarea>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mt-2">
                                ...
                                @if ($post->image)
                                    <img src="{{url('/').'/../storage/app/public/'.$post->image}}" alt="{{ $post->title }}"
