            ...
            <div class="row ">
                <div class="col-lg-12 flex justify-content-between">
                    <div class="breadcrumb-main flex justify-content-between">
                        <h4 class="text-capitalize breadcrumb-title">تعديل منشور</h4>
                        <div class="">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('service-posts.update', $servicePost->id) }}" method="post"
                                    ...
                                    <select name="service_id" id="service_id"
                                        ...
                                        @foreach ($services as $service)
                                            <option value="{{ $service->id }}"
                                                {{ $servicePost->service_id == $service->id ? 'selected' : '' }}>
                                                {{ $service->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea placeholder="وصف المنشور" name="description" id="description" rows="4"
                                        class="form-control @error('description') is-invalid @enderror">{{ $servicePost->description }}</textarea>
                                    @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
