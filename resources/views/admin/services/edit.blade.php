        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex align-items-center user-member__title mb-30 mt-30">
                    <h4 class="text-capitalize">تعديل بيانات  الخدمه</h4>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-sm-5 col-10">
                    <div class="mt-40 mb-50"> -->
                        ...
                        <form action="{{ route('services.update',$packag->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="account-profile d-flex align-items-center mb-4 " style="margin-left: 50px; justify-content:center;">
                                <div class="ap-img pro_img_wrapper">
                                    ...
                                    <label for="profile-picture">
                                        <img src="{{url('/')}}/../storage/app/public/{{$packag->photo}}" alt="user" class="profile-picture-preview ap-img__main rounded-circle wh-120 bg-lighter d-flex">
                                ...
                                <div class="account-profile__title">
                                    <h6 class="fs-15 ms-20 fw-500 text-capitalize">صوره المنتج</h6>
                                </div>
                                @error('photo')
                                    {{$message}}
                                @enderror
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text"  class="form-control mt-2"
                                        name="name" value="{{ old('name',$packag->name) }}" id="name" placeholder="الاسم">
                                    @if ($errors->has('name'))
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mt-2">
                                    <label for="price">السعر<span
                                            class="text-danger">*</span></label>
                                    <input type="text"  class="form-control mt-2"
                                        name="price" value="{{ old('price',$packag->price) }}" id="price" placeholder=" السعر">
                                    @if ($errors->has('price'))
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <label for="status"><span
                                            class="text-danger">*</span>الحاله</label>
                                            <select  class="form-control mt-2" name="status" id="status" >
                                            <option value="public" {{ $packag->status == "public" ? 'selected' : '' }}>مفعل</option>
                                            <option value="private" {{ $packag->status == "private" ? 'selected' : '' }}>غير مفعل</option>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <textarea class="form-control mt-2" name="description" style="height: 175px;padding:20px;"
                                        id="description" >{{ old('description',$packag->description) }}</textarea>
                                </div>
