        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex align-items-center user-member__title mb-30 mt-30">
                    <h4 class="text-capitalize">اضافه خدمه</h4>
                </div>
            </div>
        </div>
                        ...
                        <form action="{{ route('services.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="account-profile d-flex align-items-center mb-4 " style="margin-left: 50px; justify-content:center;">
                                ...
                                <div class="account-profile__title">
                                    <h6 class="fs-15 ms-20 fw-500 text-capitalize">صوره الخدمه</h6>
                                </div>
                                @error('photo')
                                    {{$message}}
                                @enderror
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text"  class="form-control mt-2"
                                        name="name" value="{{ old('name') }}" id="name" placeholder="الاسم">
                                    @if ($errors->has('name'))
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <label for="price">السعر<span
                                            class="text-danger">*</span></label>
                                    <input type="text"  class="form-control mt-2"
                                        name="price" value="{{ old('price') }}" id="price" placeholder=" السعر">
                                    @if ($errors->has('price'))
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <label for="status"><span
                                            ...
                                            <option value="public" {{ old('status') == "public" ? 'selected' : '' }}>مفعل</option>
                                            <option value="private" {{ old('status') == "private" ? 'selected' : '' }}>غير مفعل</option>
