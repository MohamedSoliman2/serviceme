        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex align-items-center user-member__title mb-30 mt-30">
                    <h4 class="text-capitalize">تعديل رئي عميل</h4>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-sm-5 col-10">
                    <div class="mt-40 mb-50"> -->
                        ...
                        <form action="{{ route('admin.testmonial.update',$testmonial->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="account-profile d-flex align-items-center mb-4 " style="margin-left: 50px; justify-content:center;">
                                <div class="ap-img pro_img_wrapper">
                                    ...
                                    <label for="profile-picture">
                                        <img src="{{url('/').'/../storage/app/public/'.$testmonial->image}}" alt="user" class="profile-picture-preview ap-img__main rounded-circle wh-120 bg-lighter d-flex">
                                        ...
                                        <span
                                            ...
                                            data-pick-icon="{{url('/').'/../storage/app/public/'.$testmonial->image}}"
                                        ...
                                        >
                                            <img src="{{url('/').'/../storage/app/public/'.$testmonial->image}}" alt="camera">
                                        </span>
                                    </label>
                                </div>
                                <div class="account-profile__title">
                                    <h6 class="fs-15 ms-20 fw-500 text-capitalize">صوره العميل</h6>
                                </div>
                                @error('photo')
                                    {{$message}}
                                @enderror
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <label for="name" >اسم العميل<span
                                            class="text-danger">*</span></label>
                                    <input type="text"  class="form-control mt-2"
                                        name="name" value="{{ $testmonial->name }}" id="name" placeholder="الاسم">
                                    @if ($errors->has('name'))
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mt-2">
                                    <label for="rating" >عدد النجوم<span
                                            class="text-danger">*</span></label>
                                    <input type="text"  class="form-control mt-2"
                                        name="rating" value="{{ $testmonial->rating }}" id="rating" placeholder="1:5">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mt-2">
                                    <label for="description" >رئي العميل</label>
                                    <textarea class="form-control mt-2" name="description" style="height: 175px;padding:20px;"
                                        id="description" >{{ $testmonial->description }}</textarea>
                                </div>
